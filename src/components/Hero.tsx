...
import { Download, Play, ShieldCheck, WifiOff, CheckCircle2, Wifi, Battery, Settings, Trash2, Edit3, GripVertical, SlidersHorizontal, Plus, ArrowRight, Sparkles } from 'lucide-react';
...
export default function Hero() {
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      ...
      phoneRef.current.style.transform = `perspective(1200px) rotateY(${x * 6}deg) rotateX(${-y * 6}deg)`;
    };
  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28 border-b border-slate-100 bg-gradient-to-b from-[#FAF9F5] via-white to-[#FAF9F5]">
      {/* Subtle dot grid */}
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="absolute -top-20 right-1/4 w-[600px] h-[600px] bg-gradient-to-bl from-mint/10 via-emerald/5 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-saffron/8 via-amber-500/5 to-transparent rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
              ...
              {lang === 'hi' ? (
                <>
                  ...
                  <span className="relative inline-block">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald via-[#03B459] to-mint">
                      स्मार्ट किराना
                    </span>
                    <span className="absolute -bottom-1 left-0 right-0 h-2 bg-saffron/30 -rotate-1 rounded-full" />
                  </span>{' '}
            ...
            <div className="flex flex-col sm:flex-row gap-3.5 justify-center lg:justify-start animate-slide-up" style={{ animationDelay: '0.15s' }}>
              ...
              <Button size="lg" variant="outline" asChild className="gap-2.5 border-slate/15 hover:border-emerald/30 text-[15px] font-semibold py-6 px-7 bg-white/80 backdrop-blur-sm hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 rounded-2xl">
                <Link
                  href="/?scroll=demo"
                  onClick={(e) => {
                    e.preventDefault();
          ...
          <div className="lg:col-span-5 relative flex justify-center w-full mt-8 lg:mt-0">
            ...
            >
              {/* iPhone App Screen */}
              <div className="relative z-10 mr-10 sm:mr-14">
                <IPhoneMockup height="h-[520px] sm:h-[580px]">
                  ...
                  <div className="w-full h-full bg-white flex flex-col p-3.5 pt-2">
                    ...
                    <div className="relative mb-3">
                      <div className="w-full pl-8 pr-8 py-2 text-[10px] rounded-xl border border-slate-200 bg-[#FAF9F5]/50 text-slate-400 flex items-center justify-between">
                    ...
                    <div className="flex gap-1.5 mb-3 overflow-x-auto scrollbar-none">
                      ...
                      <span className="bg-[#FAF9F5] border border-slate-100 text-slate-600 text-[9px] font-bold px-3 py-1.5 rounded-xl whitespace-nowrap">
                        {lang === 'hi' ? 'राखी' : 'Rakhi'}
                      </span>
                      <span className="bg-[#FAF9F5] border border-slate-100 text-slate-600 text-[9px] font-bold px-3 py-1.5 rounded-xl whitespace-nowrap">
                    ...
                    <div className="flex-1 space-y-2 overflow-hidden">
                      {[
                        ...
                        <div key={idx} className="bg-white rounded-2xl p-2.5 border border-slate-100 flex items-center justify-between shadow-sm">
                          ...
                          <div className="flex items-center gap-1.5 flex-shrink-0">
                            <button className="w-6 h-6 rounded-lg border border-[#03B459]/20 flex items-center justify-center bg-[#03B459]/5 hover:bg-[#03B459]/10 transition-colors">
                              <Edit3 className="w-3 h-3 text-[#03B459]" />
                            </button>
                            <button className="w-6 h-6 rounded-lg border border-red-200 flex items-center justify-center bg-red-50 hover:bg-red-100 transition-colors">
                    ...
                    {/* Bottom WhatsApp Share & Plus */}
                    <div className="mt-2.5 pt-2 border-t border-slate-100 flex gap-2">
                      <div className="flex-1 bg-[#03B459] hover:bg-[#03B459]/90 rounded-xl py-2.5 px-3 flex items-center justify-center gap-1.5 shadow-md cursor-pointer transition-colors duration-150 active:scale-98">
                      ...
                      <div className="w-9 h-9 rounded-xl bg-[#03B459] flex items-center justify-center text-white cursor-pointer active:scale-95 shadow-md">
              ...
              {/* WhatsApp Message Card (Right Overlay) */}
              <div
                className="absolute right-[-8px] sm:right-[-10px] lg:right-[-28px] top-[26%] w-[180px] sm:w-[210px] bg-white rounded-2xl shadow-[0_20px_50px_-8px_rgba(15,81,50,0.12),0_8px_16px_-4px_rgba(0,0,0,0.08)] border border-slate-100 overflow-hidden z-20 animate-pulse-subtle"
              ...
              >
                ...
                <div className="bg-[#EFEAE2] p-2.5 flex flex-col gap-2 relative min-h-[140px]">
                  {/* Green message bubble */}
                  <div className="bg-[#DCF8C6] text-slate-800 rounded-lg p-2 shadow-sm text-[9px] leading-relaxed relative self-end max-w-[95%] border-r-2 border-[#DCF8C6]">
              ...
              <div
                className="absolute right-[80px] bottom-[140px] bg-[#03B459] text-white text-[8px] font-black px-2.5 py-1 rounded-full shadow-md z-30 tracking-wider uppercase border border-white/20 animate-bounce-subtle hidden lg:block"
              ...
              <div
                className="absolute left-[-20px] sm:left-[-36px] top-[14%] bg-white/95 backdrop-blur-md rounded-2xl p-2.5 shadow-lg border border-slate-100 hidden sm:block animate-pulse-subtle z-30"
                style={{ transform: 'translateZ(20px)' }}
              >
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-lg bg-emerald/10 flex items-center justify-center text-xs">
                    🌾
                  </div>
                  <div>
                    <div className="text-[10px] font-bold text-slate leading-tight">{lang === 'hi' ? 'बारकोड की ज़रूरत नहीं' : 'No Barcode Needed'}</div>
              ...
              <div
                className="absolute left-[-28px] sm:left-[-44px] bottom-[12%] bg-white/95 backdrop-blur-md rounded-2xl p-2.5 shadow-lg border border-slate-100 hidden sm:block animate-pulse-subtle z-30"
                style={{ animationDelay: '1.2s', transform: 'translateZ(10px)' }}
              >
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-lg bg-mint/15 flex items-center justify-center text-xs">
                    🔒
                  </div>
                  <div>
